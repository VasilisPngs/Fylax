...
[UninstallRun]
Filename: "{app}\Fylax.exe"; Parameters: "--restore-dns"; Flags: waituntilterminated runhidden skipifdoesntexist; RunOnceId: "RestoreDns"
Filename: "schtasks.exe"; Parameters: "/Delete /TN ""Fylax"" /F"; Flags: runhidden; RunOnceId: "DelStartupTask"
